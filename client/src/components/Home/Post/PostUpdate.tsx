            ...
            <form onSubmit={(e)=>{e.preventDefault()}} method="POST" encType="multipart/form-data" className="modal-dialog 1modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header align-items-center">
                        <h5 className="text-dark text-center w-100 m-0" id={`update${post.id}ModalLabel`}>
                            Update Post
                        </h5>
                        ...
                        <div className="my-1 p-1">
                            <div className="d-flex flex-column">
                                ...
                                <div className="form-floating">
                                    <textarea cols={30} rows={5} value={postInfo.body} onChange={(e) => setPostInfo({ ...postInfo, body: e.target.value })} placeholder="Post Content" name="body"  className="form-control bg-gray border-0"></textarea>
                                ...
                                <div className=" d-flex flex-wrap justify-content-between border border-1 border-light rounded p-1 mt-1">
                                    {postInfo.images && postInfo.images.map((img:Record<string,any>,i:number)=>{
                                        return <div className="preview" key={i+Date.now()}>
                                            <img src={img.image} alt="" className="preview-image" />
                                            <div className="form-floating">
                                                <textarea name="captions" disabled value={img.description} placeholder="Caption" className="form-control caption"></textarea>
                                                <label>Caption</label>
                                            </div>
